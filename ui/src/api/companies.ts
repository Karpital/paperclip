...
export const companiesApi = {
  ...
  archive: (companyId: string, reason?: string) => api.post<Company>(`/companies/${companyId}/archive`, { reason }),
  unarchive: (companyId: string) => api.post<Company>(`/companies/${companyId}/unarchive`, {}),
